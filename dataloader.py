...
class PolarisDataReader(object):
    ...
    def set_up(self, folder_name=None):
        with open(folder_name+'/02-tomo/scan_information.json', 'r') as f:
          scan_information = json.load(f)
        with open(folder_name+'/02-tomo/Input/command.json', 'r') as f:
          tomo_command = json.load(f)
        with open(folder_name+'/01-ff/Input/command.json', 'r') as f:
